...
class AddFragmentChooseContinuousBengal : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.choose_option_continuous_button_7_bengal.setOnClickListener { view ->
            mission_period = "7"
        ...
        view.choose_option_continuous_button_14_bengal.setOnClickListener { view ->
            mission_period = "14"
            mission_end_date= "2020-12-31"//14일 후 날짜로 바꾸기
            bundle = bundleOf("mission_name" to mission_name, "mission_content" to mission_content, "continue_flag" to continue_flag, "mission_period" to mission_period, "mission_start_date" to mission_start_date, "mission_end_date" to mission_end_date)
        }

        view.choose_option_continuous_button_21_bengal.setOnClickListener { view ->
            mission_period = "21"
            mission_end_date= "2020-01-07"//21일 후 날짜로 바꾸기
            bundle = bundleOf("mission_name" to mission_name, "mission_content" to mission_content, "continue_flag" to continue_flag, "mission_period" to mission_period, "mission_start_date" to mission_start_date, "mission_end_date" to mission_end_date)
        }

        view.findViewById<Button>(R.id.choose_option_continuous_tv_normal_bengal).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_choose_continuous_bengal_to_add_choose_normal_bengal, bundle)
        }

        view.findViewById<Button>(R.id.choose_option_continuous_btn_to_get_randomcard_bengal).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_choose_continuous_bengal_to_add_final_bengal_fragment, bundle)
        }

        view.findViewById<ImageButton>(R.id.choose_option_continuous_back_btn_to_add_frag_bengal).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_choose_continuous_bengal_to_add_random_bengal)
        }
