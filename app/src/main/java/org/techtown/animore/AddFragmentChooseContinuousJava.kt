...
import kotlinx.android.synthetic.main.fragment_choose_option_continuous_java.*
import kotlinx.android.synthetic.main.fragment_choose_option_continuous_java.view.*
import org.techtown.animore.R
import java.time.LocalDate

class AddFragmentChooseContinuousJava : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_choose_option_continuous_java, container, false)
        ...
        view.choose_option_continuous_button_7_java.setOnClickListener { view ->
            mission_period = "7"
        ...
        view.choose_option_continuous_button_14_java.setOnClickListener { view ->
            mission_period = "14"
            mission_end_date= "2020-12-31"//14일 후 날짜로 바꾸기
            bundle = bundleOf("mission_name" to mission_name, "mission_content" to mission_content, "continue_flag" to continue_flag, "mission_period" to mission_period, "mission_start_date" to mission_start_date, "mission_end_date" to mission_end_date)
        }

        view.choose_option_continuous_button_21_java.setOnClickListener { view ->
            mission_period = "21"
            mission_end_date= "2020-01-07"//21일 후 날짜로 바꾸기
            bundle = bundleOf("mission_name" to mission_name, "mission_content" to mission_content, "continue_flag" to continue_flag, "mission_period" to mission_period, "mission_start_date" to mission_start_date, "mission_end_date" to mission_end_date)
        }

        view.findViewById<Button>(R.id.choose_option_continuous_tv_normal_java).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_choose_continuous_java_to_add_choose_normal_java, bundle)
        }

        view.findViewById<Button>(R.id.choose_option_continuous_btn_to_get_randomcard_java).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_choose_continuous_java_to_add_final_java_fragment, bundle)
        }

        view.findViewById<ImageButton>(R.id.choose_option_continuous_back_btn_to_add_frag_java).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_choose_continuous_java_to_add_random_java)
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        choose_option_continuous_tv_mission_name_java.text = mission_name
    }
}