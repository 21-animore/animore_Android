...
class AddFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.findViewById<Button>(R.id.btn_to_add_animal_guanicoe).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_fragment_to_add_animal_guanicoe)
        }

        view.findViewById<Button>(R.id.btn_to_add_animal_illipika).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_fragment_to_add_animal_illipika)
        }

        view.findViewById<Button>(R.id.btn_to_add_animal_harpseal).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_fragment_to_add_animal_harpseal)
        }

        view.findViewById<Button>(R.id.btn_to_add_animal_java).setOnClickListener {
            Navigation.findNavController(view).navigate(R.id.action_add_fragment_to_add_animal_java)
        }

        view.findViewById<Button>(R.id.btn_to_add_animal_bengal).setOnClickListener {
